...
const Works = () => {
 ...
 <section className="pt-20 h-full w-screen relative z-10 bg-[#15181e]">
      ...
      <div className="container my-10 md:mt-28 pb-60 h-full w-full ">
        <p className="heading !text-3xl md:!text-4xl lg:!text-5xl">
          A sophisticated collection of{" "}
          <span className="text-[#3d74b6]">my projects</span>
        </p>
        <div className="flex flex-wrap items-center justify-start p-4 gap-x-6 gap-y-6 mt-10">
      ...
      <span className="absolute left-0 -bottom-10 w-full   -z-10">
